...
print(df_006['BD2_1'].value_counts(dropna=False).sort_index())

df_006['BD2_1'] = np.where(df_006['BD2_1'] == 8, 0, df_006['BD2_1'])

df_007 = df_006.copy()
df_007 = df_007.rename(columns = {'current_drinking': 'drink_current'})
df_007['drink_amt'] = np.select([
    (df_007['BD2_1']== 5),(df_007['BD2_1']== 4),
    (df_007['BD2_1']== 3),(df_007['BD2_1']== 2),
    (df_007['BD2_1']== 1)
    ], [df_007['BD2_14'], 8.0, 5.5, 3.5, 1.5])

print(df_007['drink_amt'].describe())